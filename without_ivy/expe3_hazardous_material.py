...
#animation event
find_hazardous_material_event = threading.Event()
wP0 = threading.Event()
wP1 = threading.Event()
wP2 = threading.Event()
wP3 = threading.Event()
wP4 = threading.Event()
wP5 = threading.Event()
fly_to_hazardous_materiale_1 = threading.Event()
fly_to_hazardous_materiale_2 = threading.Event()
fly_to_hazardous_materiale_3 = threading.Event()
fly_to_hazardous_materiale_4 = threading.Event()
fly_to_hazardous_materiale_5 = threading.Event()
fly_to_hazardous_materiale_6 = threading.Event()
fly_to_hazardous_materiale_7 = threading.Event()
return_home = threading.Event()
wP9 = threading.Event()
wP10 = threading.Event()
wP11 = threading.Event()
...
def display_button():
    ...
    find_hazardous_material_surface = pygame.Surface((200, 100))
    return_home_surface = pygame.Surface((200, 100))
    hazardous_material_1_surface = pygame.Surface((200, 100))
    hazardous_material_2_surface = pygame.Surface((200, 100))
    hazardous_material_3_surface = pygame.Surface((200, 100))
    hazardous_material_4_surface = pygame.Surface((200, 100))
    # hazardous_material_5_surface = pygame.Surface((200, 100))
    # hazardous_material_6_surface = pygame.Surface((200, 100))
    # hazardous_material_7_surface = pygame.Surface((200, 100))
    ...
    find_hazardous_material_text = font.render("Find hazardous material", True, (255, 255, 255))
    find_hazardous_material_text_rect = find_hazardous_material_text.get_rect(center=(find_hazardous_material_surface.get_width()/2, find_hazardous_material_surface.get_height()/2))
    ...
    hazardous_material_1_text = font.render("hazardous material 1", True, (255, 255, 255))
    hazardous_material_1_text_rect = hazardous_material_1_text.get_rect(center=(hazardous_material_1_surface.get_width()/2, hazardous_material_1_surface.get_height()/2))
    
    hazardous_material_2_text = font.render("hazardous material 2", True, (255, 255, 255))
    hazardous_material_2_text_rect = hazardous_material_2_text.get_rect(center=(hazardous_material_2_surface.get_width()/2, hazardous_material_2_surface.get_height()/2))
    
    hazardous_material_3_text = font.render("hazardous material 3", True, (255, 255, 255))
    hazardous_material_3_text_rect = hazardous_material_3_text.get_rect(center=(hazardous_material_3_surface.get_width()/2, hazardous_material_3_surface.get_height()/2))
    
    hazardous_material_4_text = font.render("hazardous material 4", True, (255, 255, 255))
    hazardous_material_4_text_rect = hazardous_material_4_text.get_rect(center=(hazardous_material_4_surface.get_width()/2, hazardous_material_4_surface.get_height()/2))
    
    # hazardous_material_5_text = font.render("hazardous material 5", True, (255, 255, 255))
    # hazardous_material_5_text_rect = hazardous_material_5_text.get_rect(center=(hazardous_material_5_surface.get_width()/2, hazardous_material_5_surface.get_height()/2))
    
    # hazardous_material_6_text = font.render("hazardous material 6", True, (255, 255, 255))
    # hazardous_material_6_text_rect = hazardous_material_6_text.get_rect(center=(hazardous_material_6_surface.get_width()/2, hazardous_material_6_surface.get_height()/2))
    
    # hazardous_material_7_text = font.render("hazardous material 7", True, (255, 255, 255))
    # hazardous_material_7_text_rect = hazardous_material_7_text.get_rect(center=(hazardous_material_7_surface.get_width()/2, hazardous_material_7_surface.get_height()/2))
    ...
    find_hazardous_material_display = pygame.Rect(1140, 100, 200, 100)
    return_home_display = pygame.Rect(1360, 100, 200, 100)
    hazardous_material_1_display = pygame.Rect(1580, 100, 200, 100)
    hazardous_material_2_display = pygame.Rect(1140, 250, 200, 100)
    hazardous_material_3_display = pygame.Rect(1360, 250, 200, 100)
    hazardous_material_4_display = pygame.Rect(1580, 250, 200, 100)
    # hazardous_material_5_display = pygame.Rect(1140, 400, 200, 100)
    # hazardous_material_6_display = pygame.Rect(1360, 400, 200, 100)
    # hazardous_material_7_display = pygame.Rect(1580, 400, 200, 100)
                ...
                try:
                    ...
                    for event in pygame.event.get():
                        ...
                        if event.type == pygame.MOUSEBUTTONDOWN and event.button == 1:
                            ...
                            if find_hazardous_material_display.collidepoint(event.pos):
                                print("Find hazardous material")
                                traj_state = "find hazardous material WP0"
                                find_hazardous_material_event.set()
                                wP0.set()
                                wP1.clear()
                                wP2.clear()
                                wP3.clear()
                                ...
                                wP5.clear()
                                return_home.clear()
                                fly_to_hazardous_materiale_1.clear()
                                fly_to_hazardous_materiale_2.clear()
                                fly_to_hazardous_materiale_3.clear()
                                
                            if return_home_display.collidepoint(event.pos):
                                print("Return home")
                                traj_state = "retrun home WP9"
                                ...
                                wP11.clear()
                                wP12.clear
                                find_hazardous_material_event.clear()
                                fly_to_hazardous_materiale_1.clear()
                                fly_to_hazardous_materiale_2.clear()
                                fly_to_hazardous_materiale_3.clear()
                                fly_to_hazardous_materiale_4.clear()
                                # fly_to_hazardous_materiale_5.clear()
                                # fly_to_hazardous_materiale_6.clear()
                                # fly_to_hazardous_materiale_7.clear()
                                
                            if hazardous_material_1_display.collidepoint(event.pos):
                                print("hazardous_material 1")
                                traj_state = "hazardous_material 1"
                                fly_to_hazardous_materiale_1.set()
                                find_hazardous_material_event.clear()
                                return_home.clear()
                                fly_to_hazardous_materiale_2.clear()
                                fly_to_hazardous_materiale_3.clear()
                            ...
                            if hazardous_material_2_display.collidepoint(event.pos):
                                print("hazardous_material 2")
                                traj_state = "hazardous_material 2"
                                fly_to_hazardous_materiale_2.set()
                                find_hazardous_material_event.clear()
                                return_home.clear()
                                fly_to_hazardous_materiale_1.clear()
                                fly_to_hazardous_materiale_3.clear()
                            ...
                            if hazardous_material_3_display.collidepoint(event.pos):
                                print("hazardous_material 3")
                                traj_state = "hazardous_material 3"
                                fly_to_hazardous_materiale_3.set()
                                find_hazardous_material_event.clear()
                                return_home.clear()
                                fly_to_hazardous_materiale_1.clear()
                                fly_to_hazardous_materiale_2.clear()
                            ...
                            if hazardous_material_4_display.collidepoint(event.pos):
                                print("hazardous_material 4")
                                traj_state = "hazardous_material 4"
                                fly_to_hazardous_materiale_4.set()
                                find_hazardous_material_event.clear()
                                return_home.clear()
                                fly_to_hazardous_materiale_1.clear()
                                fly_to_hazardous_materiale_2.clear()
                            ...
                            # if hazardous_material_5_display.collidepoint(event.pos):
                            #     print("hazardous_material 5")
                            #     traj_state = "hazardous_material 5"
                            #     fly_to_hazardous_materiale_5.set()
                            #     find_hazardous_material_event.clear()
                            #     return_home.clear()
                            #     fly_to_hazardous_materiale_1.clear()
                            #     fly_to_hazardous_materiale_2.clear()
                            ...
                            # if hazardous_material_6_display.collidepoint(event.pos):
                            #     print("hazardous_material 6")
                            #     traj_state = "hazardous_material 6"
                            #     fly_to_hazardous_materiale_6.set()
                            #     find_hazardous_material_event.clear()
                            #     return_home.clear()
                            #     fly_to_hazardous_materiale_1.clear()
                            #     fly_to_hazardous_materiale_2.clear()
                            ...
                            # if hazardous_material_7_display.collidepoint(event.pos):
                            #     print("hazardous_material 7")
                            #     traj_state = "hazardous_material 7"
                            #     fly_to_hazardous_materiale_7.set()
                            #     find_hazardous_material_event.clear()
                            #     return_home.clear()
                            #     fly_to_hazardous_materiale_1.clear()
                            #     fly_to_hazardous_materiale_2.clear()
                        ...
                        if find_hazardous_material_display.collidepoint(pygame.mouse.get_pos()):
                            pygame.draw.rect(find_hazardous_material_surface, (128, 128, 128), (1, 1, 198, 98))
                        else:
                            pygame.draw.rect(find_hazardous_material_surface, (0, 0, 0), (1, 1, 198, 98))
                        ...
                        if hazardous_material_1_display.collidepoint(pygame.mouse.get_pos()):
                            pygame.draw.rect(hazardous_material_1_surface, (0, 0, 255), (1, 1, 198, 98))
                        else:
                            pygame.draw.rect(hazardous_material_1_surface, (0, 0, 128), (1, 1, 198, 98))
                        
                        if hazardous_material_2_display.collidepoint(pygame.mouse.get_pos()):
                            pygame.draw.rect(hazardous_material_2_surface, (0, 0, 255), (1, 1, 198, 98))
                        else:
                            pygame.draw.rect(hazardous_material_2_surface, (0, 0, 128), (1, 1, 198, 98))
                            
                        if hazardous_material_3_display.collidepoint(pygame.mouse.get_pos()):
                            pygame.draw.rect(hazardous_material_3_surface, (0, 0, 255), (1, 1, 198, 98))
                        else:
                            pygame.draw.rect(hazardous_material_3_surface, (0, 0, 128), (1, 1, 198, 98))
                        
                        if hazardous_material_4_display.collidepoint(pygame.mouse.get_pos()):
                            pygame.draw.rect(hazardous_material_4_surface, (0, 0, 255), (1, 1, 198, 98))
                        else:
                            pygame.draw.rect(hazardous_material_4_surface, (0, 0, 128), (1, 1, 198, 98))
                        
                        # if hazardous_material_5_display.collidepoint(pygame.mouse.get_pos()):
                        #     pygame.draw.rect(hazardous_material_5_surface, (0, 0, 255), (1, 1, 198, 98))
                        # else:
                        #     pygame.draw.rect(hazardous_material_5_surface, (0, 0, 128), (1, 1, 198, 98))
                            
                        # if hazardous_material_6_display.collidepoint(pygame.mouse.get_pos()):
                        #     pygame.draw.rect(hazardous_material_6_surface, (0, 0, 255), (1, 1, 198, 98))
                        # else:
                        #     pygame.draw.rect(hazardous_material_6_surface, (0, 0, 128), (1, 1, 198, 98))
                            
                        # if hazardous_material_7_display.collidepoint(pygame.mouse.get_pos()):
                        #     pygame.draw.rect(hazardous_material_7_surface, (0, 0, 255), (1, 1, 198, 98))
                        # else:
                        #     pygame.draw.rect(hazardous_material_7_surface, (0, 0, 128), (1, 1, 198, 98))
                    ...
                    find_hazardous_material_surface.blit(find_hazardous_material_text, find_hazardous_material_text_rect)
                    return_home_surface.blit(return_home_text, return_home_text_rect)
                    hazardous_material_1_surface.blit(hazardous_material_1_text, hazardous_material_1_text_rect)
                    hazardous_material_2_surface.blit(hazardous_material_2_text, hazardous_material_2_text_rect)
                    hazardous_material_3_surface.blit(hazardous_material_3_text, hazardous_material_3_text_rect)
                    hazardous_material_4_surface.blit(hazardous_material_4_text, hazardous_material_4_text_rect)
                    # hazardous_material_5_surface.blit(hazardous_material_5_text, hazardous_material_5_text_rect)
                    # hazardous_material_6_surface.blit(hazardous_material_6_text, hazardous_material_6_text_rect)
                    # hazardous_material_7_surface.blit(hazardous_material_7_text, hazardous_material_7_text_rect)
                    ...
                    screen.blit(find_hazardous_material_surface, (find_hazardous_material_display.x, find_hazardous_material_display.y))
                    screen.blit(return_home_surface, (return_home_display.x, return_home_display.y))
                    screen.blit(hazardous_material_1_surface, (hazardous_material_1_display.x, hazardous_material_1_display.y))
                    screen.blit(hazardous_material_2_surface, (hazardous_material_2_display.x, hazardous_material_2_display.y))
                    screen.blit(hazardous_material_3_surface, (hazardous_material_3_display.x, hazardous_material_3_display.y))
                    screen.blit(hazardous_material_4_surface, (hazardous_material_4_display.x, hazardous_material_4_display.y))
                    # screen.blit(hazardous_material_5_surface, (hazardous_material_5_display.x, hazardous_material_5_display.y))
                    # screen.blit(hazardous_material_6_surface, (hazardous_material_6_display.x, hazardous_material_6_display.y))
                    # screen.blit(hazardous_material_7_surface, (hazardous_material_7_display.x, hazardous_material_7_display.y))
...
def flight_routine(swarm, voliere):
    ...
    handler = logging.FileHandler('expe3_{nombre}_hazardous_material.log'.format(nombre = userNb), mode="a")
    ...
    file = open('expe3_secure_hazardous_materials.json')
    ...
    try:
        ...
        while time.time()-sim_start_time < 720:
            ...
            if ((time.time()-starttime > 0.025)):
                if(find_hazardous_material_event.is_set()):
                    if(wP0.is_set()): 
                        ...
                        if(dist <= epsilonDist and (angle %(2*math.pi)<= minepsilonAngle or angle%(2*math.pi) >= maxepsilonAngle)):                                                  
                            ...
                            print("WP number: 0")
                            wP0.clear()
                            traj_state = "find hazardous material WP1"
                            wP1.set()                            
                    elif(wP1.is_set()): 
                        ...
                        if(dist <= epsilonDist and (angle %(2*math.pi)<= minepsilonAngle or angle%(2*math.pi) >= maxepsilonAngle)):                                                  
                            ...
                            print("WP number: 1")
                            wP1.clear()
                            traj_state = "find hazardous material WP2"
                            wP2.set()
                    elif(wP2.is_set()): 
                        ...
                        if(dist <= epsilonDist and (angle %(2*math.pi)<= minepsilonAngle or angle%(2*math.pi) >= maxepsilonAngle)):                                                  
                            ...
                            print("WP number: 2")
                            wP2.clear()
                            traj_state = "find hazardous material WP3"
                            wP3.set()
                    elif(wP3.is_set()): 
                        ...
                        if(dist <= epsilonDist and (angle %(2*math.pi)<= minepsilonAngle or angle%(2*math.pi) >= maxepsilonAngle)):                                                  
                            ...
                            print("WP number: 3")
                            wP3.clear()
                            traj_state = "find hazardous material WP4"
                            wP4.set()
                    elif(wP4.is_set()): 
                        ...
                        dist = euclidean_distance(swarm.tellos[0].position_enu, [wPListPos[5][0], wPListPos[5][1], wPListPos[5][2]])
                        angle = heading_distance(swarm.tellos[0].get_heading(), wPListHeading[5])
                        swarm.tellos[0].fly_to_enu([wPListPos[5][0], wPListPos[5][1], wPListPos[5][2]], wPListHeading[5])
                        # if(dist <= epsilonDist and (angle %(2*math.pi)<= minepsilonAngle or angle%(2*math.pi) >= maxepsilonAngle)):                                                  
                        #     print("position: ",swarm.tellos[0].position_enu," battery: ",swarm.tellos[0].get_battery(), " distance to goal: ", dist, " angle to goal: ", angle)
                        #     print("WP number: 5")

                elif(fly_to_hazardous_materiale_1.is_set()):
                    swarm.tellos[0].fly_to_enu([wPListPos[5][0], wPListPos[5][1], wPListPos[5][2]], wPListHeading[5])
                elif(fly_to_hazardous_materiale_2.is_set()):
                    swarm.tellos[0].fly_to_enu([wPListPos[6][0], wPListPos[6][1], wPListPos[6][2]], wPListHeading[6])
                elif(fly_to_hazardous_materiale_3.is_set()):
                    swarm.tellos[0].fly_to_enu([wPListPos[7][0], wPListPos[7][1], wPListPos[7][2]], wPListHeading[7])
                elif(fly_to_hazardous_materiale_4.is_set()):
                    swarm.tellos[0].fly_to_enu([wPListPos[8][0], wPListPos[8][1], wPListPos[8][2]], wPListHeading[8])
                    
                elif(return_home.is_set()):
                    if(wP9.is_set()):
                        dist = euclidean_distance(swarm.tellos[0].position_enu, [wPListPos[9][0], wPListPos[9][1], wPListPos[9][2]])
                        angle = heading_distance(swarm.tellos[0].get_heading(), wPListHeading[9])
                        swarm.tellos[0].fly_to_enu([wPListPos[9][0], wPListPos[9][1], wPListPos[9][2]], wPListHeading[9])
                        if(dist <= epsilonDist and (angle %(2*math.pi)<= minepsilonAngle or angle%(2*math.pi) >= maxepsilonAngle)):                                                  
                            print("position: ",swarm.tellos[0].position_enu," battery: ",swarm.tellos[0].get_battery(), " distance to goal: ", dist, " angle to goal: ", angle)
                            print("WP number: 9")
                            wP9.clear()
                            traj_state = "retrun home WP10"
                            wP10.set()
                    elif(wP10.is_set()):
                        dist = euclidean_distance(swarm.tellos[0].position_enu, [wPListPos[10][0], wPListPos[10][1], wPListPos[10][2]])
                        angle = heading_distance(swarm.tellos[0].get_heading(), wPListHeading[10])
                        swarm.tellos[0].fly_to_enu([wPListPos[10][0], wPListPos[10][1], wPListPos[10][2]], wPListHeading[10])
                        if(dist <= epsilonDist and (angle %(2*math.pi)<= minepsilonAngle or angle%(2*math.pi) >= maxepsilonAngle)):                                                  
                            print("position: ",swarm.tellos[0].position_enu," battery: ",swarm.tellos[0].get_battery(), " distance to goal: ", dist, " angle to goal: ", angle)
                            print("WP number: 10")
                            wP10.clear()
                            traj_state = "retrun home WP11"
                            wP11.set()
                    elif(wP11.is_set()):
                        dist = euclidean_distance(swarm.tellos[0].position_enu, [wPListPos[11][0], wPListPos[11][1], wPListPos[11][2]])
                        angle = heading_distance(swarm.tellos[0].get_heading(), wPListHeading[11])
                        swarm.tellos[0].fly_to_enu([wPListPos[11][0], wPListPos[11][1], wPListPos[11][2]], wPListHeading[11])
                        if(dist <= epsilonDist and (angle %(2*math.pi)<= minepsilonAngle or angle%(2*math.pi) >= maxepsilonAngle)):                                                  
                            print("position: ",swarm.tellos[0].position_enu," battery: ",swarm.tellos[0].get_battery(), " distance to goal: ", dist, " angle to goal: ", angle)
                            print("WP number: 11")
                            wP11.clear()
                        ...
                        dist = euclidean_distance(swarm.tellos[0].position_enu, [wPListPos[12][0], wPListPos[12][1], wPListPos[12][2]])
                        angle = heading_distance(swarm.tellos[0].get_heading(), wPListHeading[12])
                        swarm.tellos[0].fly_to_enu([wPListPos[12][0], wPListPos[12][1], wPListPos[12][2]], wPListHeading[12])
                        if(dist <= epsilonDist and (angle %(2*math.pi)<= minepsilonAngle or angle%(2*math.pi) >= maxepsilonAngle)):                                                  
                            print("position: ",swarm.tellos[0].position_enu," battery: ",swarm.tellos[0].get_battery(), " distance to goal: ", dist, " angle to goal: ", angle)
                            print("WP number: 12")
                            wP12.clear()   
