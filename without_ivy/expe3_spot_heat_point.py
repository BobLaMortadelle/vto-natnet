...
def flight_routine(swarm, voliere):
    ...
    handler = logging.FileHandler('expe3_{nombre}_heat_point.log'.format(nombre = userNb), mode="a")
    ...
    file = open('expe3_spot_heat_points.json')
                ...
                if(find_survivor_event.is_set()):
                    ...
                    if(wP12.is_set()):
                        ...
                        if(dist <= epsilonDist and (angle %(2*math.pi)<= minepsilonAngle or angle%(2*math.pi) >= maxepsilonAngle)):                                                  
                            ...
                            print("WP number: 12")
                            wP12.clear()
                            traj_state = "retrun home WP13"
                            wP13.set()
                    elif(wP13.is_set()):
                        dist = euclidean_distance(swarm.tellos[0].position_enu, [wPListPos[13][0], wPListPos[13][1], wPListPos[13][2]])
                        angle = heading_distance(swarm.tellos[0].get_heading(), wPListHeading[13])
                        swarm.tellos[0].fly_to_enu([wPListPos[13][0], wPListPos[13][1], wPListPos[13][2]], wPListHeading[13])
                        if(dist <= epsilonDist and (angle %(2*math.pi)<= minepsilonAngle or angle%(2*math.pi) >= maxepsilonAngle)):                                                  
                            print("position: ",swarm.tellos[0].position_enu," battery: ",swarm.tellos[0].get_battery(), " distance to goal: ", dist, " angle to goal: ", angle)
                            print("WP number: 13")
                            wP13.clear()
                        ...
                        dist = euclidean_distance(swarm.tellos[0].position_enu, [wPListPos[14][0], wPListPos[14][1], wPListPos[14][2]])
                        angle = heading_distance(swarm.tellos[0].get_heading(), wPListHeading[14])
                        swarm.tellos[0].fly_to_enu([wPListPos[14][0], wPListPos[14][1], wPListPos[14][2]], wPListHeading[14])
                        if(dist <= epsilonDist and (angle %(2*math.pi)<= minepsilonAngle or angle%(2*math.pi) >= maxepsilonAngle)):                                                  
                            print("position: ",swarm.tellos[0].position_enu," battery: ",swarm.tellos[0].get_battery(), " distance to goal: ", dist, " angle to goal: ", angle)
                            print("WP number: 14")
                            wP14.clear()
                            traj_state = "retrun home WP14"
                            wP15.set()
                    elif(wP15.is_set()):
                        dist = euclidean_distance(swarm.tellos[0].position_enu, [wPListPos[15][0], wPListPos[15][1], wPListPos[15][2]])
                        angle = heading_distance(swarm.tellos[0].get_heading(), wPListHeading[15])
                        swarm.tellos[0].fly_to_enu([wPListPos[15][0], wPListPos[15][1], wPListPos[15][2]], wPListHeading[15])
                        if(dist <= epsilonDist and (angle %(2*math.pi)<= minepsilonAngle or angle%(2*math.pi) >= maxepsilonAngle)):                                                  
                            print("position: ",swarm.tellos[0].position_enu," battery: ",swarm.tellos[0].get_battery(), " distance to goal: ", dist, " angle to goal: ", angle)
                            print("WP number: 15")
                            wP15.clear()
