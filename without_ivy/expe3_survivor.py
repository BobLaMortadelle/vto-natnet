...
wP4 = threading.Event()
wP5 = threading.Event()
fly_to_victime_1 = threading.Event()
fly_to_victime_2 = threading.Event()
fly_to_victime_3 = threading.Event()
fly_to_victime_4 = threading.Event()
fly_to_victime_5 = threading.Event()
fly_to_victime_6 = threading.Event()
fly_to_victime_7 = threading.Event()
...
def display_button():
    ...
    victim_1_surface = pygame.Surface((200, 100))
    victim_2_surface = pygame.Surface((200, 100))
    victim_3_surface = pygame.Surface((200, 100))
    # victim_4_surface = pygame.Surface((200, 100))
    # victim_5_surface = pygame.Surface((200, 100))
    # victim_6_surface = pygame.Surface((200, 100))
    # victim_7_surface = pygame.Surface((200, 100))
    ...
    find_survivor_text = font.render("Find Survivor", True, (255, 255, 255))
    ...
    victim_1_text = font.render("Victim 1", True, (255, 255, 255))
    victim_1_text_rect = victim_1_text.get_rect(center=(victim_1_surface.get_width()/2, victim_1_surface.get_height()/2))
    
    victim_2_text = font.render("Victim 2", True, (255, 255, 255))
    victim_2_text_rect = victim_2_text.get_rect(center=(victim_2_surface.get_width()/2, victim_2_surface.get_height()/2))
    
    victim_3_text = font.render("Victim 3", True, (255, 255, 255))
    victim_3_text_rect = victim_3_text.get_rect(center=(victim_3_surface.get_width()/2, victim_3_surface.get_height()/2))
    
    # victim_4_text = font.render("Victim 4", True, (255, 255, 255))
    # victim_4_text_rect = victim_4_text.get_rect(center=(victim_4_surface.get_width()/2, victim_4_surface.get_height()/2))
    
    # victim_5_text = font.render("Victim 5", True, (255, 255, 255))
    # victim_5_text_rect = victim_5_text.get_rect(center=(victim_5_surface.get_width()/2, victim_5_surface.get_height()/2))
    
    # victim_6_text = font.render("Victim 6", True, (255, 255, 255))
    # victim_6_text_rect = victim_6_text.get_rect(center=(victim_6_surface.get_width()/2, victim_6_surface.get_height()/2))
    
    # victim_7_text = font.render("Victim 7", True, (255, 255, 255))
    # victim_7_text_rect = victim_7_text.get_rect(center=(victim_7_surface.get_width()/2, victim_7_surface.get_height()/2))
    ...
    victim_1_display = pygame.Rect(1580, 100, 200, 100)
    victim_2_display = pygame.Rect(1140, 250, 200, 100)
    victim_3_display = pygame.Rect(1360, 250, 200, 100)
    # victim_4_display = pygame.Rect(1580, 250, 200, 100)
    # victim_5_display = pygame.Rect(1140, 400, 200, 100)
    # victim_6_display = pygame.Rect(1360, 400, 200, 100)
    # victim_7_display = pygame.Rect(1580, 400, 200, 100)
        ...
        if(time.time() - start_interface > 0.05):
            if lock.acquire(blocking=False):
                try:
                    ...
                    for event in pygame.event.get():
                        ...
                        if event.type == pygame.MOUSEBUTTONDOWN and event.button == 1:
                            ...
                            if find_survivor_display.collidepoint(event.pos):
                                ...
                                wP5.clear()
                                return_home.clear()
                                fly_to_victime_1.clear()
                                fly_to_victime_2.clear()
                                fly_to_victime_3.clear()
                            ...
                            if return_home_display.collidepoint(event.pos):
                                ...
                                fly_to_victime_2.clear()
                                fly_to_victime_3.clear()
                                # fly_to_victime_4.clear()
                                # fly_to_victime_5.clear()
                                # fly_to_victime_6.clear()
                                # fly_to_victime_7.clear()
                                
                            if victim_1_display.collidepoint(event.pos):
                                print("Victim 1")
                                traj_state = "victim 1"
                                fly_to_victime_1.set()
                                find_survivor_event.clear()
                                return_home.clear()
                                fly_to_victime_2.clear()
                                fly_to_victime_3.clear()
                            ...
                            if victim_2_display.collidepoint(event.pos):
                                print("Victim 2")
                                traj_state = "victim 2"
                                fly_to_victime_2.set()
                                find_survivor_event.clear()
                                return_home.clear()
                                fly_to_victime_1.clear()
                                fly_to_victime_3.clear()
                            ...
                            if victim_3_display.collidepoint(event.pos):
                                print("Victim 3")
                                traj_state = "victim 3"
                                fly_to_victime_3.set()
                                find_survivor_event.clear()
                                return_home.clear()
                                fly_to_victime_1.clear()
                                fly_to_victime_2.clear()
                            ...
                            # if victim_4_display.collidepoint(event.pos):
                            #     print("Victim 4")
                            #     traj_state = "victim 4"
                            #     fly_to_victime_4.set()
                            #     find_survivor_event.clear()
                            #     return_home.clear()
                            #     fly_to_victime_1.clear()
                            #     fly_to_victime_2.clear()
                            ...
                            # if victim_5_display.collidepoint(event.pos):
                            #     print("Victim 5")
                            #     traj_state = "victim 5"
                            #     fly_to_victime_5.set()
                            #     find_survivor_event.clear()
                            #     return_home.clear()
                            #     fly_to_victime_1.clear()
                            #     fly_to_victime_2.clear()
                            ...
                            # if victim_6_display.collidepoint(event.pos):
                            #     print("Victim 6")
                            #     traj_state = "victim 6"
                            #     fly_to_victime_6.set()
                            #     find_survivor_event.clear()
                            #     return_home.clear()
                            #     fly_to_victime_1.clear()
                            #     fly_to_victime_2.clear()
                            ...
                            # if victim_7_display.collidepoint(event.pos):
                            #     print("Victim 7")
                            #     traj_state = "victim 7"
                            #     fly_to_victime_7.set()
                            #     find_survivor_event.clear()
                            #     return_home.clear()
                            #     fly_to_victime_1.clear()
                            #     fly_to_victime_2.clear()
                        ...
                        if victim_1_display.collidepoint(pygame.mouse.get_pos()):
                            pygame.draw.rect(victim_1_surface, (0, 0, 255), (1, 1, 198, 98))
                        else:
                            pygame.draw.rect(victim_1_surface, (0, 0, 128), (1, 1, 198, 98))
                        
                        if victim_2_display.collidepoint(pygame.mouse.get_pos()):
                            pygame.draw.rect(victim_2_surface, (0, 0, 255), (1, 1, 198, 98))
                        else:
                            pygame.draw.rect(victim_2_surface, (0, 0, 128), (1, 1, 198, 98))
                            
                        if victim_3_display.collidepoint(pygame.mouse.get_pos()):
                            pygame.draw.rect(victim_3_surface, (0, 0, 255), (1, 1, 198, 98))
                        else:
                            pygame.draw.rect(victim_3_surface, (0, 0, 128), (1, 1, 198, 98))
                        
                        # if victim_4_display.collidepoint(pygame.mouse.get_pos()):
                        #     pygame.draw.rect(victim_4_surface, (0, 0, 255), (1, 1, 198, 98))
                        # else:
                        #     pygame.draw.rect(victim_4_surface, (0, 0, 128), (1, 1, 198, 98))
                        
                        # if victim_5_display.collidepoint(pygame.mouse.get_pos()):
                        #     pygame.draw.rect(victim_5_surface, (0, 0, 255), (1, 1, 198, 98))
                        # else:
                        #     pygame.draw.rect(victim_5_surface, (0, 0, 128), (1, 1, 198, 98))
                            
                        # if victim_6_display.collidepoint(pygame.mouse.get_pos()):
                        #     pygame.draw.rect(victim_6_surface, (0, 0, 255), (1, 1, 198, 98))
                        # else:
                        #     pygame.draw.rect(victim_6_surface, (0, 0, 128), (1, 1, 198, 98))
                            
                        # if victim_7_display.collidepoint(pygame.mouse.get_pos()):
                        #     pygame.draw.rect(victim_7_surface, (0, 0, 255), (1, 1, 198, 98))
                        # else:
                        #     pygame.draw.rect(victim_7_surface, (0, 0, 128), (1, 1, 198, 98))
                    ...
                    victim_1_surface.blit(victim_1_text, victim_1_text_rect)
                    victim_2_surface.blit(victim_2_text, victim_2_text_rect)
                    victim_3_surface.blit(victim_3_text, victim_3_text_rect)
                    # victim_4_surface.blit(victim_4_text, victim_4_text_rect)
                    # victim_5_surface.blit(victim_5_text, victim_5_text_rect)
                    # victim_6_surface.blit(victim_6_text, victim_6_text_rect)
                    # victim_7_surface.blit(victim_7_text, victim_7_text_rect)
                    ...
                    screen.blit(victim_1_surface, (victim_1_display.x, victim_1_display.y))
                    screen.blit(victim_2_surface, (victim_2_display.x, victim_2_display.y))
                    screen.blit(victim_3_surface, (victim_3_display.x, victim_3_display.y))
                    # screen.blit(victim_4_surface, (victim_4_display.x, victim_4_display.y))
                    # screen.blit(victim_5_surface, (victim_5_display.x, victim_5_display.y))
                    # screen.blit(victim_6_surface, (victim_6_display.x, victim_6_display.y))
                    # screen.blit(victim_7_surface, (victim_7_display.x, victim_7_display.y))
...
def flight_routine(swarm, voliere):
    ...
    handler = logging.FileHandler('expe3_{nombre}_survivor.log'.format(nombre = userNb), mode="a")
    ...
    file = open('expe3_find_survivor.json')
