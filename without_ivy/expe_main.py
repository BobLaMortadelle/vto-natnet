...
def display_button():
    ...
    pygame_handler = logging.FileHandler('expe2_{nombre}.log'.format(nombre = text), mode="a")
...
def flight_routine(swarm, voliere):
    ...
    drone_position_handler = logging.FileHandler('Drone_positions_participant_{number}.log'.format(number = userNb), mode="a")
    ...
    user_position_handler = logging.FileHandler('User_positions_participant_{number}.log'.format(number = userNb), mode="a")
    ...
    bracelet_position_handler = logging.FileHandler('Bracelet_positions_participant_{number}.log'.format(number = userNb), mode="a")
